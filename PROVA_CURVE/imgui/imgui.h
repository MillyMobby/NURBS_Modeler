...
struct ImGuiIO
{
    ...
    bool        ConfigWindowsMoveFromTitleBarOnly = true; // = false       // Enable allowing to move windows only when clicking on their title bar. Does not apply to windows without a title bar.
